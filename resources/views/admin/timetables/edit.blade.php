...
@section('page-title', 'Edit Timetable Period')
...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4">
            <h2 class="text-2xl font-bold text-white">Edit Timetable Period</h2>
            <p class="text-blue-100 text-sm mt-1">Update schedule information</p>
        </div>

        <form method="POST" action="{{ route('admin.timetables.update', $timetable->id) }}" id="timetableForm" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="group">
                    ...
                    <input type="time" id="start_time" name="start_time" value="{{ old('start_time', $timetable->start_time->format('H:i')) }}" required
                ...
                <div class="group">
                    ...
                    <input type="time" id="end_time" name="end_time" value="{{ old('end_time', $timetable->end_time->format('H:i')) }}" required
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white"
                    >
                    @error('end_time')
                        <p class="text-red-500 text-xs mt-1.5 flex items-center">
                ...
                <div class="group">
                    ...
                    <input type="text" id="room" name="room" value="{{ old('room', $timetable->room) }}"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white"
                ...
                <div class="group">
                    ...
                    <input type="text" id="academic_year" name="academic_year" value="{{ old('academic_year', $timetable->academic_year) }}" required
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white"
            ...
            <div class="mt-8 pt-6 border-t border-gray-200 flex items-center justify-end gap-4">
                <a href="{{ route('admin.timetables.index', ['class_id' => $timetable->class_id, 'academic_year' => $timetable->academic_year]) }}" 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (classSelect.value) {
        loadClassSubjects(classSelect.value);
    }
});
</script>
@endsection

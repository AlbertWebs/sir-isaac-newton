...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        <div class="bg-gradient-to-r from-teal-600 to-cyan-600 px-6 py-4">
            <h2 class="text-2xl font-bold text-white">Edit Gallery Image</h2>
            <p class="text-teal-100 text-sm mt-1">Update image information</p>
        </div>

        <form method="POST" action="{{ route('admin.website.gallery.update', $galleryImage->id) }}" enctype="multipart/form-data" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6 p-4 bg-gray-50 rounded-lg border-2 border-gray-200">
                ...
                <img src="{{ asset('storage/' . $galleryImage->image) }}" alt="Current image" class="max-w-full h-64 object-contain rounded-lg shadow-sm">
            </div>

            <div class="grid md:grid-cols-2 gap-6">
                <div class="md:col-span-2 group">
                    <label for="image" class="block text-sm font-medium text-gray-700 mb-2 group-focus-within:text-teal-600 transition-colors">
                ...
                <div class="md:col-span-2 group">
                    <label for="caption" class="block text-sm font-medium text-gray-700 mb-2 group-focus-within:text-teal-600 transition-colors">
                        <span class="flex items-center">
                            <svg class="w-4 h-4 mr-1 text-gray-400 group-focus-within:text-teal-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <input type="text" id="caption" name="caption" value="{{ old('caption', $galleryImage->caption) }}" maxlength="500"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white"
                ...
                <div class="group">
                    ...
                    <input type="text" id="activity_event" name="activity_event" value="{{ old('activity_event', $galleryImage->activity_event) }}" maxlength="255"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white"
                ...
                <div class="group">
                    <label for="order" class="block text-sm font-medium text-gray-700 mb-2 group-focus-within:text-teal-600 transition-colors">
                        <span class="flex items-center">
                            <svg class="w-4 h-4 mr-1 text-gray-400 group-focus-within:text-teal-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <input type="number" id="order" name="order" value="{{ old('order', $galleryImage->order) }}" min="0"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white">
                    @error('order')
                        <p class="text-red-500 text-xs mt-1.5 flex items-center">
                            <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="md:col-span-2 group">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" id="is_visible" name="is_visible" value="1" {{ old('is_visible', $galleryImage->is_visible) ? 'checked' : '' }}

...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-purple-600 to-indigo-600 px-6 py-4">
            ...
            <p class="text-purple-100 text-sm mt-1">Add a new carousel slider image</p>
        </div>

        <form method="POST" action="{{ route('admin.website.homepage.sliders.store') }}" enctype="multipart/form-data" class="p-6">
            @csrf
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2 group">
                    ...
                    <input type="text" id="text" name="text" value="{{ old('text') }}" maxlength="500"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white"

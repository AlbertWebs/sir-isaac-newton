...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        <div class="bg-gradient-to-r from-green-600 to-emerald-600 px-6 py-4">
            ...
            <p class="text-green-100 text-sm mt-1">Update feature information</p>
        </div>

        <form method="POST" action="{{ route('admin.website.homepage.features.update', $feature->id) }}" enctype="multipart/form-data" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6 p-4 bg-gray-50 rounded-lg border-2 border-gray-200">
                ...
                <img src="{{ asset('storage/' . $feature->image) }}" alt="Current feature" class="max-w-full h-32 object-contain rounded-lg shadow-sm">
            </div>
            @endif
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div class="md:col-span-2 group">
                    ...
                    <input type="text" id="section_title" name="section_title" value="{{ old('section_title', $feature->section_title) }}" maxlength="255"
                ...
                <div class="md:col-span-2 group">
                    ...
                    <input type="text" id="section_heading" name="section_heading" value="{{ old('section_heading', $feature->section_heading) }}" maxlength="255"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white">
                ...
                <div class="group">
                    ...
                    <input type="text" id="icon" name="icon" value="{{ old('icon', $feature->icon) }}" maxlength="100"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white">
                    @error('icon')
                        <p class="text-red-500 text-xs mt-1.5 flex items-center">
                            <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="md:col-span-2 group">
                    ...
                    <input type="text" id="title" name="title" value="{{ old('title', $feature->title) }}" required maxlength="255"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white">
                    @error('title')
                        <p class="text-red-500 text-xs mt-1.5 flex items-center">
                            <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="md:col-span-2 group">
                    ...
                    <textarea id="paragraph" name="paragraph" rows="3"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white resize-none">{{ old('paragraph', $feature->paragraph) }}</textarea>
                    @error('paragraph')
                        <p class="text-red-500 text-xs mt-1.5 flex items-center">
                            <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                ...
                <div class="group">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" id="is_visible" name="is_visible" value="1" {{ old('is_visible', $feature->is_visible) ? 'checked' : '' }}

...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4">
            ...
            <p class="text-blue-100 text-sm mt-1">Update section information</p>
        </div>

        <form method="POST" action="{{ route('admin.website.homepage.sections.update', $section->id) }}" enctype="multipart/form-data" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6 p-4 bg-gray-50 rounded-lg border-2 border-gray-200">
                ...
                <img src="{{ asset('storage/' . $section->background_image) }}" alt="Current background" class="max-w-full h-32 object-cover rounded-lg shadow-sm">
            </div>
            @endif
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div class="md:col-span-2 group">
                    ...
                    <select id="section_type" name="section_type" required
                        ...
                        @foreach($sectionTypes as $type)
                            <option value="{{ $type }}" {{ old('section_type', $section->section_type) === $type ? 'selected' : '' }}>
                ...
                <div class="group">
                    ...
                    <input type="text" id="title" name="title" value="{{ old('title', $section->title) }}" maxlength="255"
                ...
                <div class="group">
                    ...
                    <input type="text" id="heading" name="heading" value="{{ old('heading', $section->heading) }}" maxlength="255"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white">
                    @error('heading')
                        <p class="text-red-500 text-xs mt-1.5 flex items-center">
                            <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="md:col-span-2 group">
                    ...
                    <textarea id="paragraph" name="paragraph" rows="3"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white resize-none">{{ old('paragraph', $section->paragraph) }}</textarea>
                    @error('paragraph')
                        <p class="text-red-500 text-xs mt-1.5 flex items-center">
                            <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                ...
                <div class="group">
                    ...
                    <input type="text" id="button_text" name="button_text" value="{{ old('button_text', $section->button_text) }}" maxlength="100"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white">
                    @error('button_text')
                        <p class="text-red-500 text-xs mt-1.5 flex items-center">
                            <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="group">
                    ...
                    <input type="text" id="button_link" name="button_link" value="{{ old('button_link', $section->button_link) }}" maxlength="255"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white">
                    @error('button_link')
                        <p class="text-red-500 text-xs mt-1.5 flex items-center">
                            <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="md:col-span-2 group">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" id="is_visible" name="is_visible" value="1" {{ old('is_visible', $section->is_visible) ? 'checked' : '' }}

...
@section('page-title', 'Homepage FAQs Management')
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden mb-6">
        <div class="bg-gradient-to-r from-yellow-600 to-amber-600 px-6 py-4">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold text-white">Homepage FAQs</h2>
                    <p class="text-yellow-100 text-sm mt-1">Manage frequently asked questions</p>
                </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gradient-to-r from-yellow-600 to-amber-600">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-xs font-semibold text-white uppercase tracking-wider">Question</th>
                        <th class="px-6 py-4 text-left text-xs font-semibold text-white uppercase tracking-wider">Answer Preview</th>
                    ...
                    <tr class="hover:bg-yellow-50 transition-colors duration-150">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end gap-2">
                                <a href="{{ route('admin.website.homepage.faqs.edit', $faq) }}" 
                                ...
                                <form action="{{ route('admin.website.homepage.faqs.destroy', $faq) }}" method="POST" 

...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        <div class="bg-gradient-to-r from-yellow-600 to-amber-600 px-6 py-4">
            <h2 class="text-2xl font-bold text-white">Create New FAQ</h2>
            <p class="text-yellow-100 text-sm mt-1">Add a new frequently asked question</p>
        </div>

        <form method="POST" action="{{ route('admin.website.homepage.faqs.store') }}" class="p-6">
            @csrf
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div class="md:col-span-2 group">
                    ...
                    <input type="text" id="title" name="title" value="{{ old('title') }}" maxlength="255"
                        ...
                        placeholder="e.g., Guide to Preschool">
                    @error('title')

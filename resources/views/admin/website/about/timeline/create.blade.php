...
@section('title', 'Create Timeline Event')
@section('page-title', 'Create New Timeline Event')

@section('content')
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        <div class="bg-gradient-to-r from-yellow-600 to-amber-600 px-6 py-4">
            <h2 class="text-2xl font-bold text-white">Create New Timeline Event</h2>
            <p class="text-yellow-100 text-sm mt-1">Add a new school history event</p>
        </div>

        <form method="POST" action="{{ route('admin.website.about.timeline.store') }}" class="p-6">
            @csrf
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2 group">
                    ...
                    <input type="text" id="title" name="title" value="{{ old('title') }}" required maxlength="255"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white"
                        placeholder="e.g., Opened its doors">
                    @error('title')
                        <p class="text-red-500 text-xs mt-1.5 flex items-center">
                            <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                ...
                <div class="group">
                    ...
                    <input type="text" id="feature_label" name="feature_label" value="{{ old('feature_label') }}" maxlength="100"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white"
                ...
                <div class="md:col-span-2 group">
                    ...
                    <textarea id="description" name="description" rows="3"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white resize-none"

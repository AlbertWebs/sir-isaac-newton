...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        <div class="bg-gradient-to-r from-green-600 to-emerald-600 px-6 py-4">
            ...
            <p class="text-green-100 text-sm mt-1">Add a new school club</p>
        </div>

        <form method="POST" action="{{ route('admin.website.about.clubs.store') }}" enctype="multipart/form-data" class="p-6">
            @csrf
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2 group">
                    ...
                    <textarea id="description" name="description" rows="4"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white resize-none"

...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        <div class="bg-gradient-to-r from-blue-600 to-cyan-600 px-6 py-4">
            <h2 class="text-2xl font-bold text-white">Create New Team Member</h2>
            <p class="text-blue-100 text-sm mt-1">Add a new team member profile</p>
        </div>

        <form method="POST" action="{{ route('admin.website.about.team.store') }}" enctype="multipart/form-data" class="p-6">
            @csrf

...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-orange-600 to-amber-600 px-6 py-4">
            <h2 class="text-2xl font-bold text-white">Create New Driver</h2>
            <p class="text-orange-100 text-sm mt-1">Add a new transportation driver</p>
        </div>

        <form method="POST" action="{{ route('admin.drivers.store') }}" enctype="multipart/form-data" class="p-6">
            @csrf
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2 group">
                    ...
                    <textarea id="address" name="address" rows="2"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white resize-none">{{ old('address') }}</textarea>
                </div>
                ...
                <div class="group">
                    ...
                    <input type="text" id="license_class" name="license_class" value="{{ old('license_class') }}" placeholder="e.g., B, C, D" required
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white">
                    @error('license_class')
                        <p class="text-red-500 text-xs mt-1.5 flex items-center">
                            <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="group">
                    ...
                    <input type="date" id="license_expiry" name="license_expiry" value="{{ old('license_expiry') }}" required
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white">

...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-pink-600 to-rose-600 px-6 py-4">
            ...
            <p class="text-pink-100 text-sm mt-1">Update announcement information</p>
        </div>

        <form method="POST" action="{{ route('admin.announcements.update', $announcement->id) }}" enctype="multipart/form-data" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div class="group">
                    ...
                    <textarea id="message" name="message" rows="6" required
                        ...
                        placeholder="Enter announcement message">{{ old('message', $announcement->message) }}</textarea>
                    @error('message')
                        <p class="text-red-500 text-xs mt-1.5 flex items-center">
                            <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                ...
                <div id="class-targeting" style="display: none;" class="group">
                    ...
                    <select id="target_classes" name="target_classes[]" multiple
                        ...
                        @foreach($classes as $class)
                            <option value="{{ $class->id }}" {{ in_array($class->id, old('target_classes', $targetClassIds)) ? 'selected' : '' }}>
                ...
                <div class="bg-gray-50 p-4 rounded-lg mb-4">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm text-gray-700">{{ $announcement->attachment_name }}</span>
                        </div>
                ...
                <div class="group">
                    <label for="attachment" class="block text-sm font-medium text-gray-700 mb-2 group-focus-within:text-pink-600 transition-colors">
                        <span class="flex items-center">
                            ...
                            {{ $announcement->hasAttachment() ? 'Replace File' : 'Upload File' }}
                        </span>
                    </label>

...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-orange-600 to-amber-600 px-6 py-4">
            <h2 class="text-2xl font-bold text-white">Edit Route</h2>
            <p class="text-orange-100 text-sm mt-1">Update route information</p>
        </div>

        <form method="POST" action="{{ route('admin.routes.update', $route->id) }}" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="group">
                    ...
                    <input type="text" id="code" name="code" value="{{ old('code', $route->code) }}" required
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white"
                ...
                <div class="group">
                    ...
                    <select id="type" name="type" required
                        ...
                        <option value="both" {{ old('type', $route->type) === 'both' ? 'selected' : '' }}>Both (Morning & Afternoon) - Recommended</option>
                        <option value="morning" {{ old('type', $route->type) === 'morning' ? 'selected' : '' }}>Morning Only (Home → School)</option>
                        <option value="afternoon" {{ old('type', $route->type) === 'afternoon' ? 'selected' : '' }}>Afternoon Only (School → Home)</option>
                    </select>
                ...
                <div class="group">
                    ...
                    <input type="time" id="morning_pickup_time" name="morning_pickup_time" value="{{ old('morning_pickup_time', $route->morning_pickup_time ? $route->morning_pickup_time->format('H:i') : '') }}"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white"
                        required>
                    <p class="text-xs text-gray-500 mt-1.5 flex items-center">
                        <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="group">
                    ...
                    <input type="time" id="morning_dropoff_time" name="morning_dropoff_time" value="{{ old('morning_dropoff_time', $route->morning_dropoff_time ? $route->morning_dropoff_time->format('H:i') : '') }}"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white"
                        required>
                    <p class="text-xs text-gray-500 mt-1.5 flex items-center">
                        <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="group">
                    ...
                    <input type="time" id="afternoon_pickup_time" name="afternoon_pickup_time" value="{{ old('afternoon_pickup_time', $route->afternoon_pickup_time ? $route->afternoon_pickup_time->format('H:i') : '') }}"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white"
                        required>
                    <p class="text-xs text-gray-500 mt-1.5 flex items-center">
                        <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="group">
                    ...
                    <input type="time" id="afternoon_dropoff_time" name="afternoon_dropoff_time" value="{{ old('afternoon_dropoff_time', $route->afternoon_dropoff_time ? $route->afternoon_dropoff_time->format('H:i') : '') }}"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white"
                        required>
                    <p class="text-xs text-gray-500 mt-1.5 flex items-center">
                        <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="group">
                    ...
                    <input type="number" id="estimated_distance_km" name="estimated_distance_km" value="{{ old('estimated_distance_km', $route->estimated_distance_km) }}" step="0.1" min="0"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white"
                ...
                <div class="group">
                    ...
                    <input type="number" id="estimated_duration_minutes" name="estimated_duration_minutes" value="{{ old('estimated_duration_minutes', $route->estimated_duration_minutes) }}" min="0"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white"
                        placeholder="e.g., 45">
                ...
                <div class="md:col-span-2 group">
                    ...
                    <textarea id="notes" name="notes" rows="3"
                        ...
                        placeholder="Additional notes about this route...">{{ old('notes', $route->notes) }}</textarea>
                    @error('notes')
                        <p class="text-red-500 text-xs mt-1.5 flex items-center">
                            <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>

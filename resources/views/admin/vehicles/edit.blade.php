...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-gray-600 to-slate-600 px-6 py-4">
            <h2 class="text-2xl font-bold text-white">Edit Vehicle</h2>
            <p class="text-gray-100 text-sm mt-1">Update vehicle information</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.vehicles.update', $vehicle->id) }}" class="p-6">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="group">
                    ...
                    <input type="number" id="capacity" name="capacity" value="{{ old('capacity', $vehicle->capacity) }}" required min="1"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-gray-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white"
                        placeholder="e.g., 14">
                    @error('capacity')
                        <p class="text-red-500 text-xs mt-1.5 flex items-center">
                ...
                <div class="group">
                    ...
                    <input type="text" id="insurance_number" name="insurance_number" value="{{ old('insurance_number', $vehicle->insurance_number) }}"
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-gray-500 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg bg-white"

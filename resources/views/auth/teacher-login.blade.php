...
<head>
    ...
    <title>Teacher Login - {{ \App\Models\Setting::get('school_name', 'Global College') }}</title>
    ...
    <div class="w-full max-w-md px-4">
        <div class="bg-white rounded-2xl shadow-xl p-8">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600">Teacher Portal</p>
            </div>
            ...
            <form method="POST" action="{{ route('teacher.login') }}" class="space-y-6">
                ...
                <div>
                    ...
                    >
                    <p class="mt-2 text-xs text-gray-500">Default password is your employee number</p>
                </div>

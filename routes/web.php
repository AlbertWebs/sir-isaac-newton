...
Route::get('/clubs', [\App\Http\Controllers\WebsiteController::class, 'clubs'])->name('website.clubs');
Route::get('/contact', [\App\Http\Controllers\WebsiteController::class, 'contact'])->name('website.contact');
Route::post('/contact', [\App\Http\Controllers\Admin\Website\ContactController::class, 'submit'])->name('website.contact.submit');
Route::get('/enroll', [\App\Http\Controllers\WebsiteController::class, 'enroll'])->name('website.enroll');
Route::post('/enroll', [\App\Http\Controllers\Website\EnrollmentSubmitController::class, 'store'])->name('website.enroll.submit');
...
Route::prefix('admin')->middleware('auth')->name('admin.')->group(function () {
    ...
    // Courses (Removed as per user request for class-based system)
    ...
    Route::prefix('website')->name('website.')->group(function () {
        ...
        // Enrollment Page
        Route::get('enrollment', [\App\Http\Controllers\Admin\Website\EnrollmentController::class, 'edit'])->name('enrollment.edit');
        Route::put('enrollment', [\App\Http\Controllers\Admin\Website\EnrollmentController::class, 'update'])->name('enrollment.update');

        // Online Applications
        Route::get('online-applications', [\App\Http\Controllers\Admin\OnlineApplicationController::class, 'index'])->name('online-applications.index');
        Route::get('online-applications/{onlineApplication}', [\App\Http\Controllers\Admin\OnlineApplicationController::class, 'show'])->name('online-applications.show');
        Route::put('online-applications/{onlineApplication}/status', [\App\Http\Controllers\Admin\OnlineApplicationController::class, 'updateStatus'])->name('online-applications.update-status');
    });
